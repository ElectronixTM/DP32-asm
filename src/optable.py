...
OP_TABLE: dict[str, OpTable] = {
        "add": {
            (Register, Register): Desc(0, Lout.MATH),
            (Register, I8): Desc(10, Lout.MATH)
            },
        "sub": {
            (Register, Register): Desc(1, Lout.MATH),
            (Register, I8): Desc(11, Lout.MATH)
            },
        "mul": {
            (Register, Register): Desc(2, Lout.MATH),
            (Register, I8): Desc(12, Lout.MATH)
            },
        "div": {
            (Register, Register): Desc(3, Lout.MATH),
            (Register, I8): Desc(13, Lout.MATH)
            },
        "and": {
            (Register, Register): Desc(4, Lout.MATH),
            },
        "or": {
            (Register, Register): Desc(5, Lout.MATH),
            },
        "xor": {
            (Register, Register): Desc(6, Lout.MATH),
            },
        "mask": {
            (Register, Register): Desc(7, Lout.MATH),
            },
        "load": {
            (Register, LMem): Desc(20, Lout.MEMORY),
            (Register, SMem): Desc(30, Lout.MEMORY)
        },
        "store": {
            (Register, LMem): Desc(21, Lout.MEMORY),
